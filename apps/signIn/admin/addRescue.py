...
@app.route('/add-rescue', methods=['GET', 'POST'])
def add_rescue():
    if request.method == 'POST':
        # Handle form submission for adding the new rescue details
        ...
        return f"New Rescue Added: {name}, {category}, {gender}, {age}, {breed}, {medical_condition}, {description}, Adopted: {adopted}"
