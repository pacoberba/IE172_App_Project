            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Row(
                            [
                                dbc.Col(dbc.Label("Adoption Application Number*", className="mt-3"), width=3),
                                dbc.Col(dbc.Input(type="text", placeholder="Enter application number", className="mb-3"), width=9),
                            ]
                        ),
                        ...
                        dbc.Row(
                            [
                                dbc.Col(dbc.Label("Payment Amount*", className="mt-3"), width=3),
                                dbc.Col(dbc.Input(type="number", placeholder="Enter payment amount", className="mb-3"), width=9),
                            ]
                        ),
                        ...
                        dbc.Row(
                            [
                                dbc.Col(dbc.Label("Mode of Payment*", className="mt-3"), width=3),
                                dbc.Col(
                                    dbc.Select(
                                        options=[
                        ...
                        dbc.Row(
                            [
                                dbc.Col(dbc.Label("Please upload a copy of your proof of payment*", className="mt-3"), width=3),
                                dbc.Col(
                                    dcc.Upload(
                                        id="upload-data",
                        ...
                        dbc.Row(
                            dbc.Col(
                                [
                                    ...
                                    dbc.Button("SUBMIT", href="/payment/paymentComplete", className="btn-custom mx-1", style={'font-family': 'Roboto', 'margin-top': '10px'})
                                ],
                                width="auto", 
                ...
                dbc.Col(
                    dbc.Card(
                        ...
                        style={"width": "75%", "align": "center", "padding": "10px", "borderRadius": "10px"},
                    ),
                    md=5,  # Image column width
                ),
            ],
            align="top",
            justify="center",
